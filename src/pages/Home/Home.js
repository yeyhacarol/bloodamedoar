    ...
    <div className={styles.home_container}>
      ...
      <div className={styles.home_content}>
          ...
          <div className={styles.see_requirements}>
            ...
            <div className={styles.requirements_bloobs}>
              ...
              <div className={styles.third_req}>
                ...
                />
                <p>
                  A idade mínima para doar é 16 anos. Pessoas com idade entre 60
                  e 69 anos só poderão doar sangue se já o tiverem feito antes
                  dos 60 anos.
                </p>
              </div>
              <div className={styles.fourth_req}>
                ...
                />
                <p>
                  Homens podem doar até 4 vezes no ano em um período de 2 meses,
                  já as mulheres podem doar até 3 vezes no ano a cada 3 meses.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className={styles.step_by_step}>
          <h2>
            Veja o passo a passo de como a doação é feita depois do agendamento
            e o pós-doação
          </h2>
          <div className={styles.top}>
            <div className={styles.step}>
              ...
              <div className={styles.step_content}>
                <p>
                  ...
                  oportunidade íntima de você indicar que seu sangue não deverá
                  ser utilizado em transfusão.
                </p>
              </div>
              <img
            ...
            <div className={styles.step}>
              ...
              <div className={styles.step_content}>
                <p>
                  Após a doação você descansará cerca de 10 minutos e em seguida
                  se dirigirá à sala de lanches. Lá, enquanto lancha, você pode
                  preencher nossa pesquisa de Satisfação e aprender um pouco
                  sobre destino da bolsa de sangue que você doou, em “PARA SER
                  LIDO APÓS A DOAÇÃO”.
                </p>
              </div>
            </div>
            ...
            <div className={styles.step}>
              ...
              <div className={styles.step_content}>
                <p>
                  ...
                  tipagem (Grupo ABO e Rh), serão realizados vários exames para
                  evidenciar uma possível infecção por Hepatites B e C, HIV,
                  HTLV, Sífilis e Doença de Chagas, e também um exame para
                  detectar uma possível alteração na Hemoglobina (proteína do
                  glóbulo vermelho que transporta oxigênio para os órgãos e
                  tecidos do corpo). O Centro de Controle de Doenças da
                  Prefeitura do Município de São Paulo requer que os Bancos de
                  Sangue notifiquem o nome de todos os doadores com exames
                  confirmadamente Positivos/Reagentes nos exames para as
                  infecções referidas.
                </p>
              </div>
            </div>
